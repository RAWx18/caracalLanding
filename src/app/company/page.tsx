  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0a0a0a]">
      ...
      <main className="flex-grow">
        <SubpageHero 
          badge="OUR MISSION"
          title="IDENTITY FOR THE AGENTIC AGE"
          subtitle="Caracal is building the trust layer for AI. We provide the infrastructure needed to deploy, manage, and scale AI agents with enterprise-grade security and transparency."
        />
...
<h2 className="text-white text-2xl sm:text-3xl font-mono uppercase font-bold leading-tight">THE NEXT EVOLUTION OF IAM</h2>
<div className="flex flex-col gap-6 text-[#999999] text-base sm:text-lg leading-relaxed font-sans opacity-80">
<p>
For decades, Identity and Access Management (IAM) has been built for humans. As we transition into the agentic age, where AI agents act on our behalf, the existing security models are breaking.
</p>
<p>
Caracal was founded to solve this fundamental challenge. We provide AI agents with their own identities, federated permissions, and cryptographic audit trails, ensuring that every action taken by an agent is authorized, transparent, and secure.
</p>
</div>

              </div>
              <div className="relative aspect-square bg-[#111111] border border-[#333333] overflow-hidden group">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-1/2 h-1/2 border border-[#cdff3e]/20 flex items-center justify-center relative">
                    ...
                    <span className="text-[#cdff3e] font-mono text-[10px] uppercase font-bold tracking-[0.2em] animate-pulse">SYSTEM_SCAN: OK</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container max-w-[1408px] mx-auto px-5 sm:px-12 desktop:px-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="border border-[#1a1a1a] p-8 hover:border-[#cdff3e]/30 transition-colors bg-[#0a0a0a]">
